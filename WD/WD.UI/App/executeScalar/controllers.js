...
app.controller("executeScalarController", ["$scope", "executeScalarFactory", function ($scope, executeScalarFactory) {
    /*root Items start*/
    rootScope.title = "WD-ExecuteScalar";
    rootScope.dataSet = "";
    rootScope.datatable = "";
    rootScope.executeNonQuery = "";
    rootScope.executeScalar = "active";
    ...
    $scope.theSqls = [
                        { commandText: "SELECT Top(1) FIRSTNAME FROM TempEmployee", commandType: { text: "Text", value: "1" }, Params: [] }
    ];
    ...
    $scope.executeScalar = function () {
        ...
        executeScalarFactory.executeScalar(JSON.stringify(input))
