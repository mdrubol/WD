...
// ***********************************************************************
// <copyright file="OracleFactory.cs" company="Western Digital">
...
namespace WD.DataAccess.Factory
{
    ...
    internal sealed class OracleFactory : FactoryBase
    {
        ...
        {
            return new OracleDatabase(connectionString, dbProvider);
        }
        ...
        {
            return new OracleDatabase(aConnect, bxConnections,txConnections);
        }
    } 
}
