...
// ***********************************************************************
// <copyright file="Db2Factory.cs" company="Western Digital">
...
namespace WD.DataAccess.Factory
{
    ...
    internal sealed class Db2Factory : FactoryBase
    {
        ...
        {
            return new Db2Database(connectionString, dbProvider);
        }
        ...
        {
            return new Db2Database(aConnect, bxConnections,txConnections);
        }
